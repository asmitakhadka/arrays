...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            medalwinner[3] = Console.ReadLine();
            ...
            if (input == 1)
            {
                Console.WriteLine("$(Gold medal winner is: {medalwinner[1]})");
            }
            else if (input == 2)
            {
                Console.WriteLine("$(Silver medal winner is: {medalwinner[2]})");
            }
            else if (input == 3)
            {
                Console.WriteLine("$(Bronze medal winner is: {medalwinner[3]})");
            }
        }
    }
}
